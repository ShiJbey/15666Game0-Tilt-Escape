...
* Finding the right way to conduct player physics and wall collision
* Rotating meshes using quaternions

Good Code:

* Best code is probably the segment of tilt_escape.hpp where I import
the levels in from map files. Keeping the .map files separate allows me
to design new maps without closing the game.
...
```
blender --background --python meshes/export-meshes.py -- meshes/tiltescapeassets.blend dist/meshes.blob
```
