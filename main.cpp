...
int main(int argc, char **argv) {
	...
	// ----------- DIRECTIONS ----------------
	printf("======= DIRECTIONS =========\n");
	printf("1) USED W,A,S,D to accelerate red ball\n");
	printf("2) Avoid guard's vision (yellow cones circling blue spheres\n");
	printf("3) Avoid holes\n");
	printf("4) Make it to the other side to go to next level\n");
